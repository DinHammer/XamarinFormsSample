...
[assembly: ExportRenderer(typeof(Dlphn.Staff.Customs.Controls.MgcFrame), typeof(MgcFrameRenderer))]

namespace Dlphn.Droid.Renderers
{
    public class MgcFrameRenderer : FrameRenderer
    {

        public MgcFrameRenderer(Context context) : base(context) { }
